...
//console.log('marina');
	$('#registro_usuario').submit(function (e) { //Cunado se de click manda a llamar las funciones de adentro se crea la función
		...
		// if(!$('#nombre').val() == '') { //Si es diferente del id del imput del nombre usuario, se realiza la funcio
			...
			$.ajax({
				url: "assets/php/registro.php", //Nombre del archivo
				type: "POST",
